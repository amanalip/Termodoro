...
# Run 151 tests and automatically clean build cache to prevent disk bloat
test:
...
help:
	...
	@echo "  make test        - Run full 151 tests and automatically clean target/ cache"
	@echo "  make test-clean  - Run tests and auto-clean (reclaims ~1.8GB disk space)"
	@echo "  make check       - Run fmt, clippy, 151 tests, and auto-clean"
