...
- **Palette Mapping**:
  ...
  - `long_break`: `#ebbcba` `Color::Rgb(235, 188, 186)` (Rose)
...
- **Palette Mapping**:
  ...
  - `long_break`: `#ff8b39` `Color::Rgb(255, 139, 57)` (Sunset Orange)
...
- **Palette Mapping**:
  ...
  - `long_break`: `#fc9867` `Color::Rgb(252, 152, 103)` (Orange)
...
- **Palette Mapping**:
  ...
  - `long_break`: `#6c71c4` `Color::Rgb(108, 113, 196)` (Violet)
