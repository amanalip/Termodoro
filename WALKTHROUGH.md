...
### Running the Test Suite & Auto-Cleaning Build Cache (311 Tests + 41 Playwright E2E Tests)
Termodoro includes a comprehensive suite of **311 automated unit, integration, property-based, and UI rendering tests**, alongside **41 Playwright cross-viewport web E2E tests**. You can execute them with automated cache cleanup to keep your disk usage slim:

```bash
# Option 1: Run all 311 Rust tests + auto-clean ~1.8GB target cache
make test
